...
implements Camera.PreviewCallback {
    ...
    public int[] getCameraCapabilities(int cameraCacheInfoIndex) {
        ...
        if (numSupportedImageSizes > 0) {
            ListIterator<E> iterSizes = supportedImageSizes.listIterator();
        ...
        if (numSupportedFrameRates > 0) {
            ListIterator<E> iterFramerates = supportedFrameRates.listIterator();
        ...
        if (numSupportedImageFormats > 0) {
            ListIterator<E> iterFormats = supportedImageFormats.listIterator();
